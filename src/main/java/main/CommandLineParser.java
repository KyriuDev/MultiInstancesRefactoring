...
public class CommandLineParser
{
    ...
    public CommandLineParser(final String[] args) throws FileNotFoundException
    {
        ...
        System.out.println("BPMN process: " + ((File) this.commands.get(CommandLineOption.BPMN_PROCESS)).getPath());
        System.out.println("Resource pool: " + this.commands.get(CommandLineOption.REAL_POOL).toString());
        System.out.println("Working directory: " + ((File) this.commands.get(CommandLineOption.WORKING_DIRECTORY)).getPath());
        System.out.println();
    }
    ...
    {
        System.out.println("IAT = null : " + this.commands.get(CommandLineOption.IAT));
        System.out.println("BPMN process : " +  this.commands.get(CommandLineOption.BPMN_PROCESS));
        System.out.println("Real pool : " +  this.commands.get(CommandLineOption.REAL_POOL));
        System.out.println("Working directory : " + this.commands.get(CommandLineOption.WORKING_DIRECTORY));
