...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        {
            e.printStackTrace();
            System.out.println("BPMN process could not be parsed properly. Exiting.");
            return;
        }
        ...
        System.out.println("Original resource pool:\n\n" + optimalPool1.toString());
        ...
        System.out.println(dependenciesParser.mainCluster().stringify(0));
        ...
        /*for (AbstractGraph abstractGraph : dependenciesParser.mainCluster().abstractGraphs())
        {
        ...
        System.out.println("Optimal BPMN process:\n\n" + optimalBPMN.toString());
        ...
        System.out.println("Optimal pool: " + optimalPool.toString());
        ...
        System.out.println("Execution time of the generated process: " + optimalProcessExecutionTime + " vs execution time of the original process: " + originalProcessExecutionTime + " (gain: " + gain + "%)");
        ...
        if (!initialDependenciesValidated)
        {
            //TODO Write the final dependencies (to compare with the original ones)
            System.out.println("Some dependencies were added to fulfill the SCC constraints." +
                    " A new dependency file has been generated.");
        }
    }
}