...
public class Cluster
{
	...
	public void addPossiblyOptimalBalancedCluster(final AbstractGraph abstractGraph)
	{
		this.possiblyOptimalBalancedClusters.add(abstractGraph);
	}

	public void addAllPossiblyOptimalBalancedClusters(final Collection<AbstractGraph> abstractGraphs)
	{
